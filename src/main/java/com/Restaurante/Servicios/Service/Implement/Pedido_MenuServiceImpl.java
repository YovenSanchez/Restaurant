...
public class Pedido_MenuServiceImpl implements Pedido_MenuService{
    ...
    public List<Pedido_Menu> findByAll() {
       ...
       @Override
    @Transactional(readOnly=true)
    public List<Pedido_Menu> consultarPedido(Integer id_pedido) {
        return pedido_menuDao.consultarPedido(id_pedido);
    }

    @Override
    @Transactional(readOnly=false)
    public void eliminarPedido_Menu(Integer id_pedido, Integer id_menu) {
        pedido_menuDao.eliminarPedido_Menu(id_pedido, id_menu);
    }
