...
@GetMapping("/visualizarPedido/{id_pedido}")
public ResponseEntity<List<Pedido_Menu>> consultarPedido(@PathVariable Integer id_pedido) {
    try {
...
public ResponseEntity<?> eliminarPedido_Menu( @RequestParam("id_pedido") Integer id_pedido, @RequestParam("id_menu") Integer id_menu) { 
try {
    pedido_menuService.eliminarPedido_Menu(id_pedido, id_menu); 
