...
clienteService.save(obj); 
 ...
 @GetMapping("/login") 
    public Cliente login(@RequestParam("nombre_cliente") String nombre_cliente,@RequestParam("numero_documento") String numero_documento){ 
        return clienteService.login(nombre_cliente, numero_documento); 
    }
}
